...
1.  **Konto erstellen**: [https://github.com/](https://github.com/)
2.  **Neues Repository auf GitHub erstellen**:
    -  Klicke `+` Symbol und wählen Sie "New repository".
    -  Geben Sie einen Namen für Ihr Repository ein (z.B. "mein_repo").
...
3.  **Lokales Repository mit GitHub verbinden**:
    ```bash
    git remote add origin https://github.com/ju1-eu/mein_repo.git
    git add .
...
2.  **Git mit Homebrew installieren**:
    ```bash
    brew update
    brew install git
    brew upgrade git
...
4. `gh auth refresh -h github.com -s delete_repo`
...
5. `gh repo create MeinProjekt2 --public`

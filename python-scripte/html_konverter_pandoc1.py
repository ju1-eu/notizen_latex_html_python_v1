...
CSS_DATEI = "navigation.css"  # Hinzugefügt: Pfad zur CSS-Datei
bib_dateien = [
    "content/literatur-kfz.bib",
    "content/literatur-sport.bib",
    "content/literatur.bib"
]
...
def markdown_nach_html_konvertieren(quell_datei, ziel_datei):
    ...
    befehl = [
        "pandoc", quell_datei, 
        "-o", ziel_datei, 
        "-c", CSS_DATEI,  # Hinzugefügt: CSS-Datei für das Styling
        "--mathjax",  # Unterstützung für MathJax
        "--citeproc",  # Zitierungsverarbeitung aktivieren
        "--csl", CSL_DATEI  # Spezifischer Zitierstil
    ]

...
# Globale Variablen
VERZEICHNIS = "./md" # anpassen
ZIELVERZEICHNIS = "./INHALTSVERZEICHNIS"
...
def verzeichnisstruktur_erzeugen(ordnerpfad, tiefe=0, root_verzeichnis=None):
    ...
    for element in sorted(os.listdir(ordnerpfad)):
        ...
        if os.path.isdir(voller_pfad):
            ...
            elif dateiendung.lower() in [".md", ".cc", ".py", ".php", ".js", ".c"]:
...
if __name__ == "__main__":
    ...
    unterstuetzte_dateiendungen = [".md", ".cc", ".py", ".php", ".pdf", ".js", ".c"]
    ...
    inhalt_html = os.path.join(ZIELVERZEICHNIS, "INHALTSVERZEICHNIS.html")
